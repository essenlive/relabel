...
let projectSchema = {}; projectInputs.forEach((el) => { projectSchema[el.name] = el.schema })
let projectInitialValues = {}; projectInputs.forEach((el) => { projectInitialValues[el.name] = el.initial })
export const projectForm = {
    inputs: projectInputs,
    schema: Yup.object().shape(projectSchema),
...
let structureSchema = {}; structureInputs.forEach((el, i) => { structureSchema[el.name] = el.schema })
let structureInitialValues = {}; structureInputs.forEach((el, i) => { structureInitialValues[el.name] = el.initial })
export const structureForm = {
    inputs: structureInputs,
    schema: Yup.object().shape(structureSchema),
...
let communitySchema = {}; communityInputs.forEach((el, i) => { communitySchema[el.name] = el.schema })
let communityInitialValues = {}; communityInputs.forEach((el, i) => { communityInitialValues[el.name] = el.initial })
export const communityForm = {
    inputs: communityInputs,
    schema: Yup.object().shape(communitySchema),
